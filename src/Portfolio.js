...
const aboutMe = {
	...
	skills: [
		...
		'⚡ Familiarity with Familiarity with RESTful APIs,Redux, React Hooks and working of modern authorization mechanisms, such as JSON Web Token',
		'⚡ Ability to work in a collaborative team environment and adapt to chainging environment',
		'⚡ Good analytical and problem-solving skills',
		'⚡ Experience working with version control systems such as Git and dataBases like MongoDb,MySql/Oracle',
